...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/convolution/convolution_fft_1000000007.test.cpp\"\
    ...
    \ &o) const {\n    Poly res = *this;\n    return res *= o;\n  }\n\nprivate:\n\
    \  vector<T> _v;\n};\n} // namespace maomao90\n#line 5 \"verify/yosupo/convolution/convolution_fft_1000000007.test.cpp\"\
    \nusing namespace maomao90;\nusing mint = static_modint<1000000007>;\nusing poly\
    \ = Poly<mint, PolySetting::fft_sqrt>;\n\nint n, m;\n\nint main() {\n  ios::sync_with_stdio(0),\
    \ cin.tie(0);\n  cin >> n >> m;\n  poly a(n), b(m);\n  for (int i = 0; i < n;\
    \ i++) {\n    cin >> a[i];\n  }\n  for (int i = 0; i < m; i++) {\n    cin >> b[i];\n\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/convolution/convolution_fft_1000000007.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/convolution/convolution_fft_1000000007.test.cpp
- /verify/verify/yosupo/convolution/convolution_fft_1000000007.test.cpp.html
