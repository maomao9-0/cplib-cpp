...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo/convolution/convolution.test.cpp\"\n#define\
    ...
    \ &o) const {\n    Poly res = *this;\n    return res *= o;\n  }\n\nprivate:\n\
    \  vector<T> _v;\n};\n} // namespace maomao90\n#line 5 \"verify/yosupo/convolution/convolution.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/yosupo/convolution/convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo/convolution/convolution.test.cpp
- /verify/verify/yosupo/convolution/convolution.test.cpp.html
